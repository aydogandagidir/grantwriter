# AGENTS.md — Bluedev GrantWriter

> Bu dosya proje köküne kopyalanmalı. Codex her oturumda bu dosyayı otomatik okur.
...
### External APIs
- **LLM:** Anthropic Codex (Opus 4.7 primary, Sonnet 4.6 secondary)
